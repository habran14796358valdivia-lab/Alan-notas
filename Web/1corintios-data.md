...
- ἡγιασμένοις (V-RPP-DPM) santificados [NF]
- οὔσῃ (V-PAP-DSF) siendo [NF]
- ἐπικαλουμένοις (V-PMP-DPM) invocando [NF]
- καὶ = (y)
...
- ὑστερεῖσθαι (V-PMN) faltar [NF]
- ἀπεκδεχομένους (V-PMP-APM) esperando [NF]
- ὥστε = (de manera que)
...
- λέγητε (V-PAS-2P) ==digan== [F]
- ᾖ (V-PAS-3S) ==haya== [F]
- ἦτε (V-PAS-2P) ==estén== [F]
- κατηρτισμένοι (V-RPP-NPM) unidos [NF]
- δὲ = (pero) [c]
- ἵνα = (para que) [i]
- καὶ = (y)
- δὲ = (pero) [c]
...
- ἐδηλώθη (V-API-3S) ==he sido informado== [F]
- εἰσιν (V-PAI-3P) ==hay== [F]
- γάρ = (porque) [i]
- ὅτι = (que) [i]
...
- ἐσταυρώθη (V-API-3S) ==fue crucificado== [F]
- ἐβαπτίσθητε (V-API-2P) ==fueron bautizados== [F]
- μὴ = (no)
- ἢ = (o)

### 1 Corintios 1:14 {#1co-1-14}
...
- βαπτίζειν (V-PAN) bautizar [NF]
- εὐαγγελίζεσθαι (V-PMN) predicar [NF]
- κενωθῇ (V-APS-3S) ==se haga vana== [F]
- οὐ = (no)
- γὰρ = (porque) [i]
- ἀλλὰ = (sino) [c]
- οὐκ = (no)
...
- ἀπολλυμένοις (V-PPP-DPM) se pierden [NF]
- ἐστίν (V-PAI-3S) ==es== [F]
- σῳζομένοις (V-PPP-DPM) son salvos [NF]
- ἐστιν (V-PAI-3S) ==es== [F]
- γὰρ = (porque) [i]
- μὲν = ()
- δὲ = (pero) [c]
...
- ἐμώρανεν (V-AAI-3S) ==ha hecho necedad== [F]
- οὐχὶ = (¿no?)
...
- πιστεύοντας (V-PAP-APM) creen [NF]
- ἐπειδὴ = (ya que) [i]
- γὰρ = (porque) [i]
- ἐν = (en)
- οὐκ = (no)
...
- ἐσταυρωμένον (V-RPP-ASM) crucificado [NF]
- δὲ = (pero) [c]
- μὲν = ()
- δὲ = (pero) [c]
...
- καυχήσηται (V-ADS-3S) ==se jacte== [F]
- ὅπως = (para que) [i]
- μὴ = (no)
...
- γέγραπται (V-RPI-3S) ==está escrito== [F]
- καυχώμενος (V-PMP-NSM) se gloría [NF]
- καυχάσθω (V-PMM-3S) ==gloríese== [F]
- ἵνα = (para que) [i]
- καθὼς = (tal como)
- ἐν = (en)
...
- καταγγέλλων (V-PAP-NSM) proclamando [NF]
...
- λαλοῦμεν (V-PAI-1P) ==hablamos== [F]
- ἀποκεκρυμμένην (V-RPP-ASF) oculta [NF]
...
ἣν οὐδεὶς τῶν ἀρχόντων τοῦ αἰῶνος τούτου ἔγνωκεν, εἰ γὰρ ἔγνωσαν, οὐκ ἂν τὸν κύριον τῆς δόξης ἐσταύρωσαν·
 [Esta sabiduría que ninguno...]

- ἔγνωκεν (V-RAI-3S) ==ha entendido== [F]
...
- οἶδεν (V-RAI-3S) ==conoce== [F]
- ἔγνωκεν (V-RAI-3S) ==conoce== [F]
- γὰρ = (porque) [i]
- εἰ = (si) [i]
- μὴ = (no)
- ἐν = (en)
...
- χαρισθέντα (V-APP-APN) ha dado [NF]
- δὲ = (pero) [c]
- οὐ = (no)
- ἀλλὰ = (sino) [c]
- ἐκ = (de)
...
ὅταν γὰρ λέγῃ τις Ἐγὼ μέν εἰμι Παύλου ἕτερος δέ Ἐγὼ Ἀπολλῶ οὐκ ἄνθρωποί ἐστε;
 [Porque cuando uno dice: «Yo soy de Pablo», y otro: «Yo soy de Apolos», ¿no son ustedes hombres?]

- λέγῃ (V-PAS-3S) ==dice== [F]
- εἰμι (V-PAI-1S) ==soy== [F]
- ἐστε (V-PAI-2P) ==son== [F]
   - ὅταν = cuando [i]
   - γὰρ = porque [i]
...
τί οὖν ἐστιν Ἀπολλῶς τί δέ ἐστιν Παῦλος διάκονοι διʼ ὧν ἐπιστεύσατε καὶ ἑκάστῳ ὡς ὁ κύριος ἔδωκεν
 [¿Qué es, pues, Apolos? ¿Y qué es Pablo? Servidores por medio de los cuales ustedes creyeron, según lo que a cada uno concedió el Señor.]
...
- ηὔξανεν (V-IAI-3S) ==daba crecimiento== [F]
   - ἀλλὰ = pero [c]
...
- φυτεύων (V-PAP-NSM) planta [NF]
- ἐστίν (V-PAI-3S) ==es== [F]
- ποτίζων (V-PAP-NSM) riega [NF]
- αὐξάνων (V-PAP-NSM) da crecimiento [NF]
   - ὥστε = así que [i]
   - οὔτε = ni
   - οὔτε = ni
   - ἀλλʼ = sino [c]
...
ὁ φυτεύων δὲ καὶ ὁ ποτίζων ἕν εἰσιν ἕκαστος δὲ τὸν ἴδιον μισθὸν λήμψεται κατὰ τὸν ἴδιον κόπον
 [El que planta y el que riega son una misma cosa; pero cada uno recibirá su propia recompensa conforme a su propia labor.]
...
θεοῦ γάρ ἐσμεν συνεργοί θεοῦ γεώργιον θεοῦ οἰκοδομή ἐστε
 [Porque nosotros somos colaboradores de Dios, y ustedes son labranza de Dios, edificio de Dios.]
...
κατὰ τὴν χάριν τοῦ θεοῦ τὴν δοθεῖσάν μοι ὡς σοφὸς ἀρχιτέκτων θεμέλιον ἔθηκα ἄλλος δὲ ἐποικοδομεῖ ἕκαστος δὲ βλεπέτω πῶς ἐποικοδομεῖ
 [Conforme a la gracia de Dios que me fue dada, yo, como sabio arquitecto, puse el fundamento, y otro edifica encima; pero cada uno tenga cuidado cómo edifica sobre él.]

- δοθεῖσαν (V-APP-ASF) dada [NF]
...
- κείμενον (V-RPP-ASM) está puesto [NF]
- ἐστιν (V-PAI-3S) ==es== [F]
   - γὰρ = porque [i]
   - οὐδεὶς = nadie
   - παρὰ = fuera de
...
εἰ δέ τις ἐποικοδομεῖ ἐπὶ τὸν θεμέλιον χρυσὸν ἄργυρον λίθους τιμίους ξύλα χόρτον καλάμην
 [Y si alguien edifica sobre el fundamento con oro, plata, piedras preciosas, madera, heno o paja,]
...
- ἀποκαλύπτεται (V-PPI-3S) ==es revelada== [F]
- ἐστιν (V-PAI-3S) ==es== [F]
...
- ἐποικοδόμησεν (V-AAI-3S) ==ha edificado== [F]
- λήμψεται (V-FMI-3S) ==recibirá== [F]
   - εἴ = si [i]
   - ὃ = que [i]
...
εἴ τινος τὸ ἔργον κατακαήσεται ζημιωθήσεται αὐτὸς δὲ σωθήσεται οὕτως δὲ ὡς διὰ πυρός
 [Si la obra de alguien es consumida por el fuego, él sufrirá pérdida; sin embargo, él será salvo, aunque así como por fuego.]

- κατακαήσεται (V-FPI-3S) ==será consumida== [F]
...
οὐκ οἴδατε ὅτι ναὸς θεοῦ ἐστε καὶ τὸ πνεῦμα τοῦ θεοῦ οἰκεῖ ἐν ὑμῖν
 [¿No saben ustedes que son templo de Dios y que el Espíritu de Dios habita en ustedes?]
...
εἴ τις τὸν ναὸν τοῦ θεοῦ φθείρει φθερεῖ τοῦτον ὁ θεός ὁ γὰρ ναὸς τοῦ θεοῦ ἅγιός ἐστιν οἵτινες ἐστε ὑμεῖς
...
μηδεὶς ἑαυτὸν ἐξαπατάτω εἴ τις δοκεῖ σοφὸς εἶναι ἐν ὑμῖν ἐν τῷ αἰῶνι τούτῳ μωρὸς γενέσθω ἵνα γένηται σοφός
 [Que nadie se engañe a sí mismo. Si alguno entre ustedes se cree sabio en este siglo, que se haga necio para llegar a ser sabio.]

- ἐξαπατάτω (V-PAM-3S) ==se engañe== [F]
- δοκεῖ (V-PAI-3S) ==se cree== [F]
- εἶναι (V-PAN) ser [NF]
- γενέσθω (V-ADM-3S) ==se haga== [F]
...
ἡ γὰρ σοφία τοῦ κόσμου τούτου μωρία παρὰ τῷ θεῷ ἐστιν γέγραπται γάρ Ὁ δρασσόμενος τοὺς σοφοὺς ἐν τῇ πανουργίᾳ αὐτῶν
 [Porque la sabiduría de este mundo es necedad ante Dios. Pues escrito está: «EL QUE PRENDE A LOS SABIOS EN SU PROPIA ASTUCIA».]

- ἐστιν (V-PAI-3S) ==es== [F]
- γέγραπται (V-RPI-3S) ==está escrito== [F]
- δρασσόμενος (V-PMP-NSM) prende [NF]
   - γὰρ = porque [i]
   - παρὰ = ante
   - γάρ = porque [i]
   - ἐν = en
...
εἴτε Παῦλος εἴτε Ἀπολλῶς εἴτε Κηφᾶς εἴτε κόσμος εἴτε ζωή εἴτε θάνατος εἴτε ἐνεστῶτα εἴτε μέλλοντα πάντα ὑμῶν
 [ya sea Pablo, o Apolos, o Cefas, o el mundo, o la vida, o la muerte, o lo presente, o lo por venir, todo es de ustedes,]
...
- σύνοιδα (V-RAI-1S) ==estoy consciente== [F]
- δεδικαίωμαι (V-RPI-1S) ==he sido justificado== [F]
...
- μετεσχημάτισα (V-AAI-1S) ==apliqué== [F]
- μάθητε (V-AAS-2P) ==aprendan== [F]
- γέγραπται (V-RPI-3S) ==está escrito== [F]
- φυσιοῦσθε (V-PPS-2P) ==se envanezcan== [F]
...
- λαβών (V-AAP-NSM) habiendo recibido [NF]
...
- κεκορεσμένοι (V-RPP-NPM) saciados [NF]
- ἐστέ (V-PAI-2P) ==están== [F]
- ἐπλουτήσατε (V-AAI-2P) ==se hicieron ricos== [F]
- ἐβασιλεύσατε (V-AAI-2P) ==reinaron== [F]
- ἐβασιλεύσατε (V-AAI-2P) ==reinaron== [F]
- συμβασιλεύσωμεν (V-AAS-1P) ==reinemos== [F]
...
- ἐγενήθημεν (V-ADI-1P) ==llegamos a ser== [F]
...
- πεφυσιωμένοι (V-RPP-NPM) envanecidos [NF]
- ἐστέ (V-PAI-2P) ==están== [F]
- ἐπενθήσατε (V-AAI-2P) ==se entristecieron== [F]
- ἀρθῇ (V-APS-3S) ==sea quitado== [F]
- ποιήσας (V-AAP-NSM) habiendo hecho [NF]
...
- ἀπὼν (V-PAP-NSM) estando ausente [NF]
- παρὼν (V-PAP-NSM) estando presente [NF]
...
ἐκκαθάρατε τὴν παλαιὰν ζύμην, ἵνα ἦτε νέον φύραμα, καθώς ἐστε ἄζυμοι. καὶ γὰρ τὸ πάσχα ⸀ἡμῶν ἐτύθη Χριστός·
 [Limpien la levadura vieja...]

- ἐκκαθάρατε (V-AAM-2P) ==limpien== [F]
- ἦτε (V-PAS-2P) ==sean== [F]
- ἐστε (V-PAI-2P) ==son== [F]
- ἐτύθη (V-API-3S) ==fue sacrificado== [F]
...
Ἔγραψα ὑμῖν ἐν τῇ ἐπιστολῇ μὴ συναναμίγνυσθαι πόρνοις,
 [En mi carta les escribí...]

- ἔγραψα (V-AAI-1S) ==escribí== [F]
- συναναμίγνυσθαι (V-PMN) juntarse [NF]
...
⸀οὐ πάντως τοῖς πόρνοις τοῦ κόσμου τούτου ἢ τοῖς πλεονέκταις ⸀καὶ ἅρπαξιν ἢ εἰδωλολάτραις, ἐπεὶ ⸀ὠφείλετε ἄρα ἐκ τοῦ κόσμου ἐξελθεῖν.
 [No me refería a la gente inmoral de este mundo...]

- ὠφείλετε (V-IAI-2P) ==tenían que== [F]
...
νῦν δὲ ἔγραψα ὑμῖν μὴ συναναμίγνυσθαι ἐάν τις ἀδελφὸς ὀνομαζόμενος ᾖ πόρνος ἢ πλεονέκτης ἢ εἰδωλολάτρης ἢ λοίδορος ἢ μέθυσος ἢ ἅρπαξ, τῷ τοιούτῳ μηδὲ συνεσθίειν.
 [Sino que en efecto les escribí...]

- ἔγραψα (V-AAI-1S) ==escribí== [F]
- συναναμίγνυσθαι (V-PMN) juntarse [NF]
- ὀνομαζόμενος (V-PPP-NSM) siendo llamado [NF]
- ᾖ (V-PAS-3S) ==sea== [F]
- συνεσθίειν (V-PAN) comer con [NF]
