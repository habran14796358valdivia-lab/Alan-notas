...
**(VERIFICAR EN EL INTERLINEAL GRIEGO- MODO INDICATIVO, SUBJUNTIVO,IMPERATIVO O OPTATIVO)**
...
cada uno ==recibirá== su propia recompensa

nosotros ==somos== colaboradores

ustedes ==son== el campo de cultivo

yo, como sabio arquitecto, ==puse== el fundamento, 

otro ==edifica sobre él==. 
...
1. **MARCAR TODOS LOS CONECTORES**
2.  **VERIFICAR EN EL INTERLINEAL**
3.  **(SOLO CONOECTORES QUE UNAN 2 VERBOS FINITOS / CLAUSULAS)**



Así que yo, hermanos, no ==pude== hablarles como a espirituales, sino como a carnales, como a niños en Cristo. Les ==di a beber== leche, no alimento sólido, [porque]() todavía no ==podían== *recibirlo*. En verdad, +[PERO]()+ni aun ahora ==pueden==, [porque]() todavía ==son== carnales. [Pues]() habiendo celos [y]() discusiones entre ustedes, ¿no ==son== carnales [y]() ==andan== como hombres del mundo? [Porque]() cuando uno ==dice==:+[DE HECHO]()+«Yo ==soy== de Pablo», [y]() otro: «Yo soy de Apolos», ¿no ==son== *como* hombres *del mundo?* ¿Qué ==es==, [pues](), Apolos? ¿[Y]() qué ==es== Pablo? Servidores mediante los cuales ustedes ==han creído==,+[Y]()+ según el Señor ==dio== *oportunidad* a cada uno. Yo ==planté==, Apolos ==regó==, [pero]() Dios ==ha dado el crecimiento==. [Así que]() ni el que planta ni el que riega ==es== algo, [sino]() Dios, que da el crecimiento. [Ahora bien](), el que planta y el que riega ==son== una misma cosa, [pero]() cada uno ==recibirá== su propia recompensa conforme a su propio trabajo. [Porque]() nosotros ==somos== colaboradores en la labor de Dios, y ustedes ==son== el campo de cultivo de Dios, el edificio de Dios.
...
​				 [y]() otro: «Yo soy de Apolos», ¿no ==son== *como* hombres 
...
​			[Porque]() nosotros ==somos== colaboradores 
 ...
 Y ustedes ==son== el campo de cultivo de Dios
...
​		[pero]() cada uno ==recibirá== recompensa 

​			[Porque]()  ==somos== colaboradores 

 Y ustedes ==son== el campo de cultivo 
...
**PASO 8 - ELIMINAR INDENTADOS**

MARCAMOS SUJETO Y MOVIMIENTO
